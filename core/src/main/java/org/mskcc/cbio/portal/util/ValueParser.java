...
//      }
    ...
    */
   static public ValueParser generateValueParser(String gene, String value, double mRnaZscoreUpThreshold,
                                                 double mRnaZscoreDownThreshold, double proteinZscoreUpThreshold,
                                                 double proteinZscoreDownThreshold, OncoPrintSpecification theOncoPrintSpecification) {
