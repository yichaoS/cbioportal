...
(function (Vue, iViz, $) {
  Vue.component('chartOperations', {
    template:'<div class="study-view-chart-header">' +
            ...
            '<img v-show="hasFilters" src="images/dashboard/reload-alt.svg" @click="reset()" class="study-view-title-icon hover"/>'+
            ...
            '<img v-if="showTableIcon" src="images/dashboard/table.svg" class="study-view-title-icon hover" @click="changeView()"/>' +
            '<img v-if="showPieIcon" src="images/dashboard/pie.svg" class="study-view-title-icon hover" @click="changeView()"/>' +
            '<img v-if="showSurvivalIcon" src="images/dashboard/survival_icon.svg" class="study-view-title-icon hover"/>' +
            '<div id="{{chartId}}-download-icon-wrapper" class="study-view-download-icon">' +
            '<img src="images/dashboard/in.svg" class="study-view-title-icon hover" id="{{chartId}}-download"/>'+
            '</div>'+
            '<img src="images/dashboard/move.svg" class="dc-chart-drag study-view-title-icon" class="study-view-title-icon"/>'+
